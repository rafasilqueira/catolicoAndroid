...
class AcitivityInsertEditUser : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        TextView(this@AcitivityInsertEditUser)
        setupToolbar()
        setFilters()
        setupUserStatus()
    ...
    private fun saveUpdateUser(usuario: Usuario) {
        ...
        call.enqueue(object : CallBackDialog<Boolean>(this@AcitivityInsertEditUser) {

            override fun onResponse(call: Call<Boolean>, response: Response<Boolean>) {
                super.onResponse(call, response)
                ToastMisc.sucess(this@AcitivityInsertEditUser)
            ...
            override fun onFailure(call: Call<Boolean>, t: Throwable) {
                ...
                ToastMisc.generalError(this@AcitivityInsertEditUser)
            }
        })
